...
разные изображения. Создайте несколько копий фоновых обоев и нарисуйте на 
одной копии книжную полку, на другой — стол с лампой и так 
далее. Затем измените код класса Game, чтобы там загружались 
(и вперемежку выводились на экран) несколько изображений (три или четыре)
''')
from tkinter import *
import random
import time
...
class Game:
    def __init__(self):
        ...
        self.bg3 = PhotoImage(file="C:\\user\\Desktop\\Python\\stickman\\background3.gif")
        self.bg4 = PhotoImage(file="C:\\user\\Desktop\\Python\\stickman\\background4.gif")
